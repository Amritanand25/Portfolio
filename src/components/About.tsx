...
export const About: React.FC = () => {
  return (
    <section className="py-20 dark:bg-gray-900 bg-gray-50 relative">
      <FloatingMolecules />
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-300">Passionate about creating efficient and scalable web solutions</p>
            </motion.div>
            <motion.div
              whileHover={{ scale: 1.05 }}
              className="p-6 rounded-lg bg-white dark:bg-gray-800 shadow-lg"
            >
              ...
              <h3 className="text-xl font-semibold mb-2 dark:text-white">Problem Solver</h3>
              <p className="text-gray-600 dark:text-gray-300">Love tackling complex challenges and finding elegant solutions</p>
            </motion.div>
            <motion.div
              whileHover={{ scale: 1.05 }}
              className="p-6 rounded-lg bg-white dark:bg-gray-800 shadow-lg"
            >
              ...
              <h3 className="text-xl font-semibold mb-2 dark:text-white">Continuous Learner</h3>
