...
const projects = [
  {
    title: "Video Player",
    description: "A web app with infinite commenting, live chat, and optimized performance, increasing engagement by 50%.",
    ...
    liveUrl: "https://example.com/video-player",
    githubUrl: "https://github.com/yourusername/video-player",
    category: "Full Stack"
  },
  {
    title: "Schedule Meeting",
    description: "A scheduling app with intuitive features built using TypeScript, React, and Tailwind CSS.",
    ...
    liveUrl: "https://example.com/schedule-meeting",
    githubUrl: "https://github.com/yourusername/schedule-meeting",
    category: "Frontend"
  },
  {
    title: "CodePad",
    description: "A real-time collaborative coding platform using React, Node, and WebSocket.",
    image: "https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=800&auto=format&fit=crop&q=60",
    technologies: ["React", "Node.js", "WebSocket", "MongoDB"],
    liveUrl: "https://example.com/codepad",
    githubUrl: "https://github.com/yourusername/codepad",
    category: "Full Stack"
  }
];
